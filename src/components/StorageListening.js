...
export default function StorageListening() {
    return(
            <div style={{ margin: "auto" }}>
                <h2 style={{ fontSize: "36px", lineHeight: "50px", marginTop: "15px", textAlign: "center", fontWeight: "normal" }}>Browse stores in Houston</h2>
